...
public class WinningTickets {
    ...
    public WinningTickets() {
        winningTickets.put(Rank.FIRST, 0);
        winningTickets.put(Rank.SECOND, 0);
        winningTickets.put(Rank.THIRD, 0);
        winningTickets.put(Rank.FORTH, 0);
        winningTickets.put(Rank.FIFTH, 0);
    }
